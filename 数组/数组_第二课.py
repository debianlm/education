...
'''
问题0: 打开你的电脑，运行下程序，看看得到了什么结果？
问题1: 为什么 方法二中，第12行如果删除，运行下程序看看有什么问题？
问题2: 数组中如果用 [-1] 表示在数组中第几位？
－－－ 课后作业－－－－
1. 温习第12章，列表
2. 回答下面2个问题
问题3: 仔细观察print语句的用法，温习下，如果不懂，打开课本复习下第2章
问题4: 如果把时间从30天延长到60天，请模范老师的程序算算能够得到多少收入? 你能读出这个数值吗?
'''
